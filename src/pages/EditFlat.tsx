...
export default function EditFlat() {
  ...
  const [fetchingFlat, setFetchingFlat] = useState(true);
    ...
    try {
      ...
      if (!data) {
        toast({
          ...
          description: "This flat doesn't exist or you don't have permission to edit it.",
          variant: "destructive",
        });
        navigate('/flats');
        return;
      ...
      toast({
        title: "Error",
        description: "Failed to load flat details.",
        variant: "destructive",
      });
      navigate('/flats');
    } finally {
      setFetchingFlat(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Flat listing updated successfully!",
        description: "Your flat listing has been updated.",
      });

      navigate('/flats');
    } catch (error) {
      console.error('Error updating flat listing:', error);
      toast({
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold">Edit Flat Listing</h1>
            <p className="text-muted-foreground">Update your flat listing details</p>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update the details of your flat listing
            </CardDescription>
          </CardHeader>
          <CardContent>
